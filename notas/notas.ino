...
const int RELE_DO  = 8;  // Letra 'C' (OJOS SERRADOS)
const int RELE_RE  = 7;  // Letra 'D' (sejas arriba)
const int RELE_MI  = 6;  // Letra 'E' (sejas juntas)
const int RELE_FA  = 5;  // Letra 'F' (voca abajo)
const int RELE_SOL = 4;  // Letra 'G' (sonrisa)

// Variables para el control de tiempo (Medio segundo)
unsigned long tiempoActivacion = 0;
const long DURACION = 500;  // 0.5 segundos por nota
